  ...
  return (
    <section className="mx-auto max-w-[1440px] px-6 lg:px-20 3xl:px-0 flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2 ">
        ...
        <p className="text-[16px] font-normal mt-6 text-gray-30 xl:max-w-[520px]">
        ...
        <div className="my-11 flex flex-wrap gap-5">
          ...
          <p className="text-[16px] font-bold lg:text-[20px] text-blue-70">
            198k
            <span className="text-[16px] font-normal lg:text-[20px] ml-1 ">
              Excellent Reviews
            </span>
          </p>
        </div>
      ...
      <div className="relative flex flex-1 items-start">
        <div className="relative z-20 w-[268px] flex flex-col gap-8 rounded-2xl bg-green-90 px-7 py-8">
          <div className="flex flex-col">
            <div className="flex items-center justify-between">
              <p className="text-[16px] text-gray-20 font-normal">Location</p>
          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              <p className="text-[16px] font-normal block text-gray-20">
                Distance
              </p>
